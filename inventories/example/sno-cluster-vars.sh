...
export CLUSTER_INGRESS_VIP="192.168.1.100"
export CLUSTER_API_VIP="192.168.1.101"
export CLUSTER_MACHINE_NETWORK="192.168.1.0/24"
...
export CLUSTER_NODE_NET_DNS_SERVERS=("1.1.1.1" "8.8.8.8")

## Set Node Network Configuration
NODE1_CFG='{"name": "ocp01", "role": "control-plane", "mac_address": "52:54:00:00:00:01", "ipv4": {"address": "192.168.1.51", "gateway": "192.168.1.1", "prefix": "24", "iface": "enp1s0"}}'
#NODE2_CFG='{"name": "ocp02", "role": "control-plane", "mac_address": "52:54:00:00:00:02", "ipv4": {"address": "192.168.1.52", "gateway": "192.168.1.1", "prefix": "24", "iface": "enp1s0"}}'
#NODE3_CFG='{"name": "ocp03", "role": "control-plane", "mac_address": "52:54:00:00:00:03", "ipv4": {"address": "192.168.1.53", "gateway": "192.168.1.1", "prefix": "24", "iface": "enp1s0"}}'

#NODE4_CFG='{"name": "ocp04", "role": "application-node", "mac_address": "52:54:00:00:00:04", "ipv4": {"address": "192.168.1.54", "gateway": "192.168.1.1", "prefix": "24", "iface": "enp1s0"}}'
#NODE5_CFG='{"name": "ocp05", "role": "application-node", "mac_address": "52:54:00:00:00:05", "ipv4": {"address": "192.168.1.55", "gateway": "192.168.1.1", "prefix": "24", "iface": "enp1s0"}}'
#########################################################
## Remove _ front of variable below to add 3 workers on first install
#NODE6_CFG='{"name": "ocp06", "role": "application-node", "mac_address": "52:54:00:00:00:06", "ipv4": {"address": "192.168.1.56", "gateway": "192.168.1.1", "prefix": "24", "iface": "enp1s0"}}'

#########################################################
####INSERT NEW NODES UNDER HERE

## Add Nodes to the JSON array
export NODE_CFGS='{ "nodes": [ '${NODE1_CFG}'] }'
